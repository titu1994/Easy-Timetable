...
public class AdminUI extends javax.swing.JFrame {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (name.equals("123") && pass.equals("123")) {
					TimeTableUI t = new TimeTableUI();
					t.setVisible(true);
					setVisible(false);
				}
				else {
					AdminData admin = AdminDB.getAdminData();
					if(admin.userName.equals(name) && admin.getPassword().equals(pass)) {
						TimeTableUI t = new TimeTableUI();
						t.setVisible(true);
						setVisible(false);
					}
												...
												groupLayout
														...
														.addGroup(
																...
																groupLayout
																		...
																		.addGap(554))))
						.addGroup(
								groupLayout.createSequentialGroup().addGap(505)
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AdminUI.class.getName()).log(
